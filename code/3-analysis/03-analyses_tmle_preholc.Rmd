...
vars_exposure_ab_0m <- holc_neighborhoods_exp %>%
  ...
  mutate(wells_0m_all                  = wells_0km_all,
         ...
         wells_0m_all_preholc          = wells_0km_all_preholc,
         wells_0m_all_preholc_density  = (wells_0km_all_preholc / area_sqkm),
         wells_0m_all_postholc         = wells_0km_all_postholc,
...
# fits model
model_ab_0m_all_preholc = ltmle(data   = data_tmle,
                                Anodes = "treatment",
                                Lnodes = NULL,
                                Ynodes = "wells_0km_all_preholc",  #_density
                                gform  = gform,
                                abar   = list(1, 0),
                                SL.library          = SL.library,
                                observation.weights = holc_matched_ab_0m$weights)
summary(model_ab_0m_all_preholc)
```
...
model_ab_0m_all_preholc = ltmle(data   = data_tmle,
                                Anodes = "treatment",
                                Lnodes = NULL,
                                Ynodes = "wells_0m_all_preholc_density",
                                gform  = gform,
                                abar   = list(1, 0),
                                SL.library          = SL.library,
                                observation.weights = holc_matched_ab_0m$weights)
...
# fits model
model_ab_100m_all_preholc = ltmle(data   = data_tmle,
                                  Anodes = "treatment",
                                  Lnodes = NULL,
                                  Ynodes = "wells_100m_all_preholc",  #_density
                                  gform  = gform,
                                  abar   = list(1, 0),
                                  SL.library          = SL.library,
                                  observation.weights = holc_matched_ab_100m$weights)
summary(model_ab_100m_all_preholc)
```
...
# creates dataset for ltmle function call
data_tmle = holc_matched_ab_100m[, c(covars_list, 
                                     "wells_100m_all_preholc_density",
                                     "treatment")]
# sets array and dim using propensity scores (cpa)
gform = array(c(holc_matched_ab_100m$cpa1,
                1 - holc_matched_ab_100m$cpa1),
...
model_ab_100m_all_preholc = ltmle(data   = data_tmle,
                                  Anodes = "treatment",
                                  Lnodes = NULL,
                                  Ynodes = "wells_100m_all_preholc_density",
                                  gform  = gform,
                                  abar   = list(1, 0),
                                  SL.library          = SL.library,
                                  observation.weights = holc_matched_ab_100m$weights)
...
# fits model
model_bc_0m_all_preholc = ltmle(data   = data_tmle,
                                Anodes = "treatment",
                                Lnodes = NULL,
                                Ynodes = "wells_0m_all_preholc",  #_density
                                gform  = gform,
                                abar   = list(1, 0),
                                SL.library          = SL.library,
                                observation.weights = holc_matched_bc_0m$weights)
summary(model_bc_0m_all_preholc)
```
...
# fits model
model_bc_100m_all_preholc = ltmle(data   = data_tmle,
                                  Anodes = "treatment",
                                  Lnodes = NULL,
                                  Ynodes = "wells_100m_all_preholc",  #_density
                                  gform  = gform,
...
summary(model_bc_100m_all_preholc)
```
...
# fits model
model_cd_0m_all_preholc = ltmle(data   = data_tmle,
                                Anodes = "treatment",
                                Lnodes = NULL,
                                Ynodes = "wells_0m_all_preholc",  #_density
                                gform  = gform,
...
summary(model_cd_0m_all_preholc)
```
...
# fits model
model_cd_100m_all_preholc = ltmle(data   = data_tmle,
                                  Anodes = "treatment",
                                  Lnodes = NULL,
                                  Ynodes = "wells_100m_all_preholc",  #_density
                                  gform  = gform,
...
summary(model_cd_100m_all_preholc)
```
