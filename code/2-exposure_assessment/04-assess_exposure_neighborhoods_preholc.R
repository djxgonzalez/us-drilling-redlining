...
holc_neighborhoods <- 
  ...
  mutate(neighborhood = as.character(neighborho),
         year_appraised = replace_na(year_appraised, 1935)) %>%  # deals with missing data
...
wells_pre1940_sf <- readRDS("data/interim/wells_interim.rds") %>%
  drop_na(longitude) %>%
...
wells_all       <- wells_pre1940_sf %>%
  filter(production_type == "OIL" | 
           production_type == "GAS" |
           production_type == "OIL & GAS" |
           production_type == "INJECTION" |
           production_type == "UNKNOWN")
wells_injection <- wells_pre1940_sf %>% filter(production_type == "INJECTION")
wells_oil_gas   <- wells_pre1940_sf %>% filter(production_type == "OIL" | 
                                                 production_type == "GAS" |
                                                 production_type == "OIL & GAS")
wells_unknown   <- wells_pre1940_sf %>% filter(production_type == "UNKNOWN")
...
write_csv(holc_neighborhoods_buffer_0km_wells_all,
          "data/interim/holc_neighborhoods_buffer_0km_wells_all_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_100m_wells_all,
          "data/interim/holc_neighborhoods_buffer_100m_wells_all_preholc.csv")
...
#           "data/interim/holc_neighborhoods_buffer_1km_wells_all_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_0km_wells_injection,
          "data/interim/holc_neighborhoods_buffer_0km_wells_injection_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_100m_wells_injection,
          "data/interim/holc_neighborhoods_buffer_100m_wells_injection_preholc.csv")
...
#           "data/interim/holc_neighborhoods_buffer_1km_wells_injection_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_0km_wells_oil_gas,
          "data/interim/holc_neighborhoods_buffer_0km_wells_oil_gas_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_100m_wells_oil_gas,
          "data/interim/holc_neighborhoods_buffer_100m_wells_oil_gas_preholc.csv")
...
#           "data/interim/holc_neighborhoods_buffer_1km_wells_oil_gas_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_0km_wells_unknown,
          "data/interim/holc_neighborhoods_buffer_0km_wells_unknown_preholc.csv")
...
write_csv(holc_neighborhoods_buffer_100m_wells_unknown,
          "data/interim/holc_neighborhoods_buffer_100m_wells_unknown_preholc.csv")
...
#           "data/interim/holc_neighborhoods_buffer_1km_wells_unknown_preholc.csv")
